...
wget https://raw.githubusercontent.com/chilman408/teslausb/master/setup/windows/WpaSupplicantConf.psm1 -OutFile WpaSupplicantConf.psm1
wget https://raw.githubusercontent.com/chilman408/teslausb/master/setup/windows/add-wifi.ps1 -OutFile add-wifi.ps1
